...
<div id="nav-body">
  ...
  <p>Perhatikan Contoh 3. Adakah butiran algoritma cukup jelas? Jika tidak, anda
    ...
    <p>Komputer ialah alat elektronik yang berupaya menerima dan memproses
      ...
      “menghidupkan” perkakasan komputer dengan memproses semua input
      ...
      <p>Terdapat dua format perwakilan algoritma, iaitu pseudokod dan carta alir.<br>
        <b>• Pseudokod</b> ialah senarai struktur kawalan komputer yang ditulis dalam bahasa pertuturan manusia
        dan mempunyai nombor turutan.<br>
        <b>• Carta alir</b> adalah alternatif kepada pseudokod menggunakan simbol grafik untuk mewakili arahanarahan penyelesaian.</p>
