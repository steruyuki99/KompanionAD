...
<!--Nav Body-->
    ...
    <div class="main_visual">
        <div class="slide-bottom show">
            ...
            <a href="material/1.4.1.jsp" class="button">Struktur Kawalan</a>
            <a href="material/1.5.1.jsp" class="button">Amalan Terbaik Pengaturcaraan</a>
            <a href="material/1.6.1.jsp" class="button">Struktur Data dan Modular</a>
            <a href="material/1.7.1.jsp" class="button">Pembangunan Aplikasi</a>
            <a href="material/summary.jsp" class="button">Summary</a>
