...
public class FQ2 {
    ...
    public ArrayList<String> getAnswerRecords(String user) throws SQLException{
        ...
        try (Statement stmt = con.createStatement()) {
            String sql = "SELECT ans1, ans2, ans3 FROM formativetwo WHERE username='" + user + "'";
    ...
    public int getScore(String user) throws SQLException{
        ...
        try (Statement stmt = con.createStatement()) {
            ...
            if(this.answer1.equals("C")){
                score++;
            }
            
            if(this.answer2.equals("A")){
                score++;
            }
            
            if(this.answer3.equals("B")){
                score++;
            }
    ...
    public ArrayList<Boolean> getAnswerBoolean(String user) throws SQLException{
        ...
        try (Statement stmt = con.createStatement()) {
            ...
            answerBool.add(this.ans1 = this.answer1.equals("C"));
            answerBool.add(this.ans2 = this.answer2.equals("A"));
            answerBool.add(this.ans3 = this.answer3.equals("B"));
    ...
    public void updateAnswerDB(String user, String a1, String a2, String a3){
        ...
        try {
                ...
                String sqlInsert = "UPDATE formativetwo SET ans1=?, ans2=?, ans3=? WHERE username=?";
                try (PreparedStatement as = con.prepareStatement(sqlInsert)) {
